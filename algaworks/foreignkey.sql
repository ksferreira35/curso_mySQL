...
INSERT INTO pedidos (data_creation, data_entrega, valor_frete, valor_total, cliente_id, obs)
VALUES 
    ("2025-01-04 15:45:21", "2025-01-23", 5.34, 99.99, 2, "Entrega Urgente"),
    ("2014-07-11 15:22:00", "2014-07-15", 33.00, 400.00, 2, "Entrega Normal"),
    ("2025-03-01 09:10:00", "2025-03-10", 12.00, 150.00, 1, "Pedido com observação especial"),
    ("2025-04-15 18:30:45", "2025-04-20", 8.50, 200.00, 1, "Entrega no fim de semana");
